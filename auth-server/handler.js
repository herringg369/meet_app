...
const credentials = {
  ...
  redirect_uris: ["https://herringg369.github.io/meet_app/"],
  javascript_origins: ["https://herringg369.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  const code = decodeURIComponent(`${event.results.data.items}`)
